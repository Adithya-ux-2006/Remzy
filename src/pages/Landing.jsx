    ...
    <PageWrapper className="min-h-screen flex flex-col">
      <section className="relative pt-24 pb-16 px-6 lg:px-8 overflow-hidden">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="w-14 h-14 mx-auto rounded-2xl shadow-[0_4px_24px_hsl(0_0%_0%/0.3)] dark:shadow-[0_4px_24px_hsl(152_40%_48%/0.3)] bg-[hsl(210_30%_9%)] flex items-center justify-center">
