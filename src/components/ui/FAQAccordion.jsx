...
function BlurredStagger({ text, instant = false }) {
...
export function FAQAccordion({ items, bordered = false, instant = false }) {
...
<span><BlurredStagger text={line} instant={instant} /></span>
                </li>
              ))}
            </ul>
          ) : (
            <BlurredStagger text={item.answer} instant={instant} />
          )}
          </div>
        );
        ...
        return (
          <div
            ...
            className={cn(
              ...
              instant ? '' : 'transition-shadow duration-200',
          ...
          >
            ...
            >
              <div className={cn(
                ...
                instant ? '' : 'transition-colors duration-200',
              ...
              <ChevronDown className={cn(
                ...
                instant ? '' : 'transition-transform duration-200',
            ...
            {instant ? (
              isOpen ? (
                <div className="overflow-hidden">{answerBody}</div>
              ) : null
            ) : (
